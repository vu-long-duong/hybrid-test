                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="widget widget_tag_cloud">
                        ...
                        <div class="tagcloud">
                            ...
                            <a href="{{route('page.tag-detail',['slug'=>$tag->content])}}">{{$tag->content}}</a>
                            @endforeach
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="widget">
                        ...
                        <ul class="contact_info_list">
                            <li><i class="fa fa-map-marker"></i> 219 Trung Kinh, Ha Noi</li>
                            <li><i class="fa fa-phone"></i> +088 012121240</li>
                            <li><i class="fa fa-envelope-o"></i> Info@website.com <br> duonglongvujvcr@mail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="widget widget_recent_post">
                        ...
                        <div class="single-post-list-wrap style-white">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{asset('img/post/list/1.png')}}" alt="img">
                                </div>
                        ...
                        <div class="single-post-list-wrap style-white">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{asset('img/post/list/2.png')}}" alt="img">
                                </div>
                                <div class="media-body">
                                    <div class="details">
                                        <div class="post-meta-single">
